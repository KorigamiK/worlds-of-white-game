...
# write version
print('decoration', 3, file=file)

# write parameters
print(8.5, 7.0, 1.0, file=file)
print(1.5, 2.5, 4.0, file=file)

# write bounding box
print(obj.bound_box[0][0], obj.bound_box[0][1], obj.bound_box[0][2], file=file)
print(obj.bound_box[6][0], obj.bound_box[6][1], obj.bound_box[6][2], file=file)
